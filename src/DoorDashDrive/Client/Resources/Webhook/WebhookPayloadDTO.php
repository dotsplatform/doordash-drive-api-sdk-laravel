<?php
/**
 * Description of WebhookPayloadDTO.php
 * @copyright Copyright (c) DOTSPLATFORM, LLC
 * @author    Bogdan Mamontov <bohdan.mamontov@dotsplatform.com>
 */

namespace Dots\DoorDashDrive\Client\Resources\Webhook;

use Dots\Data\DTO;
use Dots\DoorDashDrive\Client\Resources\Consts\DeliveryStatus;
use Dots\DoorDashDrive\Client\Resources\Consts\WebhookEventType;
use Dots\DoorDashDrive\Client\Resources\DasherLocation;

class WebhookPayloadDTO extends DTO
{
    protected string $external_delivery_id;

    protected ?WebhookEventType $event_name;
    ...
    public function getEventName(): ?WebhookEventType
    {
